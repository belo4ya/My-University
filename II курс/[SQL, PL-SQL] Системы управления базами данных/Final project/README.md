...
| **Location** |  |  |  | характеризуется | место проведения для |  |  |  |  |  |  |  |  | характеризуется |  |  |  |  |  |
| **Map** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | характеризуется |  |  |  |
| **Match comment** |  |  |  |  |  |  |  | ответ на |  | относится к |  |  |  |  |  |  |  |  | написан |
| **Match type** |  |  |  |  |  |  |  |  |  | характеризует |  |  |  |  |  |  |  |  |  |
| **Match** |  |  |  |  | принадлежит |  | играется на | содержит | характеризуется |  |  |  |  |  |  | характеризуется |  | проводится между |  |
| **Player status** |  |  |  |  |  |  |  |  |  |  |  |  | характеризует |  |  |  |  |  |  |
| **Player team** |  |  |  |  |  |  |  |  |  |  |  | характеризует | характеризует |  |  |  |  |  |  |
| **Player** | имеет |  |  |  |  |  |  |  |  |  | характеризуется | характеризуется |  |  |  |  |  | состоит в | фаворит для |
| **Region** |  |  |  | содержит |  | характеризует |  |  |  |  |  |  |  |  |  |  |  |  |  |
| **Role** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | характеризует |
| **Score** |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| **Sponsor** |  |  |  |  | проводит |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| **Team** | имеет |  |  |  | участвует в |  |  |  |  | участвует в |  | характеризуется | содержит |  |  | характеризуется |  |  | фаворит для |
| **User** |  | написал | написал |  |  |  |  | написал |  |  |  |  | выбрал |  | характеризуется |  |  | выбрал |  |
